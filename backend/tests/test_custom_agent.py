...
class TestAgentsAPI:
    ...
    def test_install_workflow_steward_template(self, agent_client, tmp_path):
        ...
        assert "workflow_governance_list" in config["allowed_tools"]
        assert "workflow_governance_status" in config["allowed_tools"]
        assert "workflow_validation_start" in config["allowed_tools"]
        assert "workflow_observation_get" in config["allowed_tools"]
        assert "workflow_evidence_timeline" in config["allowed_tools"]
        assert "workflow_evidence_digest" in config["allowed_tools"]
        assert "workflow_evidence_ingest" in config["allowed_tools"]
        assert "workflow_problem_report" in config["allowed_tools"]
        assert "workflow_feedback_report" in config["allowed_tools"]
